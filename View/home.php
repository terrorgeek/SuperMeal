...
<center><h1>What Did You Eat Today?</h1></center>
...
<center><fieldset>
	<form action="../Controller/eat_action.php" method="post" id="form1" class="navbar-form">
	   ...
	   <input type="button" value="add breakfast" class="btn btn-primary" onclick="add_breakfast();"/><br/><br>
	   lunch:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='lunch' id='meal_lunch' style='height: 30px;' />&nbsp;&nbsp;&nbsp;&nbsp;
	   <input type="button" value="add lunch" class="btn btn-primary" onclick="add_lunch();" /><br/><br>
	   dinner:&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='dinner' id='meal_dinner' style='height: 30px;' />&nbsp;&nbsp;&nbsp;
	   <input type="button" value="add dinner" class="btn btn-primary" onclick="add_dinner();" /><br/><br>
...
</fieldset></center><br/><br/><br/><br/><center>
<strong>Breakfast:</strong><div id="breakfast_div"></div>
<strong>Lunch:</strong><div id="lunch_div"></div>
<strong>Dinner:</strong><div id="dinner_div"></div></center>
	</body>
<script>
$(function() {
